      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-24 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full lg:h-auto sm:px-24 md:px-10 object-cover object-center rounded"
              src="https://m.media-amazon.com/images/I/41VyuGAOQUL._AC_SX679_.jpg"
            />
